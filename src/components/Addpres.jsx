...
//     const confirmed = window.confirm("Are you want to add this description..!");
//     if (confirmed) {
//       try {
//         const response = await axios.post(`http://localhost:8080/api/medical-fields/${mediacalFieldId}/sub-departments`, subDept, {
//           headers: {
...
//     try {
//       const response = await axios.post('http://localhost:8080/api/medical-fields', newField, {
//         headers: {
//           'Content-Type': 'application/json',
//         },
//       });
